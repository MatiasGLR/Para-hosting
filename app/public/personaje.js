async function cargarpersonaje() {
    ...
    try {
        ...
        if(resJson.status === "Ok") {
            ...
            document.querySelector("#personaje_datos-imagen").innerHTML = "<img src='"+resJson.rows[0].imagen+"' alt='char_Imagen'>";

            document.querySelector("#personaje_datos-nombre").value = nombrePersonaje;
            ...
            document.querySelector("#personaje_datos-maldicion").value = datos.maldicion;
